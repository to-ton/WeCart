...
public class EditDeleteProducts extends AppCompatActivity {
    ...
    private void updateProduct() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/editproductinfo.php?username="+ txtusername +"&old_product="+ oldproduct +"&product_name="+ txtproductname +"&product_type="+ txttype +"&description="+ txtdesc +"&price="+ txtprice +"&stock="+ txtstock +"";
    ...
    public void deleteProduct(){
        try {
            ...
            String url ="https://jarvis.danlyt.ninja/wecart-api/v1/delete.php?seller="+ name +"&product_name="+ ProductName +"";
