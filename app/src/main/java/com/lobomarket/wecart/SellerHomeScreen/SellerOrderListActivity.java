...
public class SellerOrderListActivity extends AppCompatActivity {
    ...
    private void generateQRCode() {
        try {
            ...
            String JSON_URL = "https://wecart.gq/wecart-api/deliver.php?ship_ready&tracking_id="+ txtTracking +"&uname_1="+ txtseller +"";
            requestQueue = Volley.newRequestQueue(SellerOrderListActivity.this);
    ...
    private void getQRCode() {
        try {
            ...
            String JSON_URL = "https://wecart.gq/wecart-api/deliver.php?ship_ready&tracking_id="+ txtbuyer +"&seller="+ txtseller +"";
    ...
    private void checkQrCode() {
        try {
            ...
            String JSON_URL = "https://wecart.gq/wecart-api/deliver.php?seller="+ txtseller +"&tracking_id="+ txtbuyer +"";
