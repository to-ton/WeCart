...
public class EditSellerShopAccount extends AppCompatActivity {
    ...
    private void updateAccount() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/edituserinfo.php?seller&username="+ txtsellername +"&name="+ txtfullname +"&brgy="+ txtbrgy +"&sitio="+ txtsitio +"&street="+ txtstreet +"&contact_num="+ txtcontact +"&contact_email="+ txtemail +"&store_name="+ txtshopname +"&decription=null&store_type="+ txtstoretype +"";
    ...
    private void uploadPhoto(){
        try {
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/upload_user_profile.php";
            RequestQueue requestQueue = Volley.newRequestQueue(EditSellerShopAccount.this);
            StringRequest postRequest = new StringRequest(
                    Request.Method.POST,
                    JSON_URL,
