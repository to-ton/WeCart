    ...
    private void addProducts(){
        ...
        try {
            ...
            try {
                ...
                String JSON_URL = "https://wecart.gq/wecart-api/add_product.php?username="+ sellerNameTxt +"&product_name="+ txtproductName +"&product_type="+ txtproductType +"&description="+ txtdescription +"&stock="+txtstock +"&price="+ txtprice +"";
                RequestQueue requestQueue = Volley.newRequestQueue(AddNewProduct.this);
                StringRequest postRequest = new StringRequest(
                        Request.Method.POST,
                        JSON_URL,
