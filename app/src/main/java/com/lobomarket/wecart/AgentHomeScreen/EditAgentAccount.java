...
public class EditAgentAccount extends AppCompatActivity {
    ...
    private void updateAccount() {
        try{
            ...
            String JSON_URL = "https://wecart.gq//wecart-api/edituserinfo.php?agent&username="+ txtusername +"&name="+ txtfullname +"&brgy="+ txtbrgy +"&sitio="+ txtsitio +"&street="+ txtstreet +"&contact_num="+ txtcontact +"&contact_email="+ txtemail +"";
            RequestQueue requestQueue = Volley.newRequestQueue(EditAgentAccount.this);
