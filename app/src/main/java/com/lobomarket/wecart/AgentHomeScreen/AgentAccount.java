...
public class AgentAccount extends AppCompatActivity {
    ...
    private void awayOff() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/agent.php?away_off="+ txtAgent +"";
    ...
    private void awayOn() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/agent.php?away_on="+ txtAgent +"";
            requestQueue = Volley.newRequestQueue(AgentAccount.this);
            StringRequest postRequest = new StringRequest(
                    Request.Method.POST,
                    JSON_URL,
    ...
    public void logout(){
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/logout.php?username="+ txtAgent +"";
            requestQueue = Volley.newRequestQueue(AgentAccount.this);
            StringRequest postRequest = new StringRequest(
                    Request.Method.POST,
                    JSON_URL,
    ...
    private void showAgentAccount() {
        try{
            ...
            String url = "https://jarvis.danlyt.ninja/wecart-api/v1/profile_info.php?username="+ txtagent +"";
            requestQueue = Volley.newRequestQueue(AgentAccount.this);
