...
public class AgentGroceryList extends AppCompatActivity{
    ...
    private void markAsDelivered() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/deliver.php?ship_success&tracking_id="+ txtTracking +"";
            requestQueue = Volley.newRequestQueue(AgentGroceryList.this);
    ...
    private void showSummary() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/deliver.php?agent="+ txtagent +"&tracking_id="+ txtTracking +"";
    ...
    public void outForDelivery(){
        try {
            ...
            String url = "https://jarvis.danlyt.ninja/wecart-api/v1/deliver.php?ship_now&rider="+ txtAgent +"&tracking_id="+ txtTracking +"&key="+ txtQRkey +"";
            requestQueue = Volley.newRequestQueue(AgentGroceryList.this);
            StringRequest postRequest = new StringRequest(
                    Request.Method.POST,
                    url,
