            ...
            holder.btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (currentQuantity < currentStock){
                        ...
                        String url = "https://jarvis.danlyt.ninja/wecart-api/v1/show-orders.php?update&username="+ txtBuyer +"&product_name="+ txtProduct +"&seller_uname="+ txtSeller +"&quantity="+ quantity +"";
