...
public class LoginFormFragment extends Fragment {
                            ...
                            try {
                                ...
                                if(email.getText().length() != 0){
                                    ...
                                    StringRequest stringRequest = new StringRequest(
                                            Request.Method.GET,
                                            "https://jarvis.danlyt.ninja/wecart-api/v1/forgot_password.php?email="+ txtEmail +"",
    ...
    private void login(){
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/login.php?username="+ username +"&password="+ password +"";
