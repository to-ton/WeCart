...
public class LocationFormFragment extends Fragment {
    ...
    private void registerUser() {
        try {
            ...
            String JSON_URL = "https://wecart.gq/wecart-api/register.php?buyer&name="+fullname+"&username="+ username +"&password="+ password +"&brgy="+ brgy +"&sitio="+ sitio +"&street="+ street +"&contact_num="+ contact +"&contact_email="+ email +"";
