...
public class fragmentCateg1 extends Fragment implements ProductsCustomAdapter.OnItemClickListener {
    private RecyclerView recyclerView;
    private ProductsCustomAdapter cAdapter;
    private RecyclerView.LayoutManager layoutManager;
    List<Product> product;
    private static String JSON_URL = "https://my-json-server.typicode.com/cubby02/Fake_API/fruits";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.category1);
        product = new ArrayList<>();
        errorPhoto = view.findViewById(R.id.error);
        errorText = view.findViewById(R.id.noInternet);
        swipeRefreshLayout = view.findViewById(R.id.categ1Refresh);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        cAdapter.setOnItemClickListener(fragmentCateg1.this);
