...
public class fragmentCateg3 extends Fragment implements ProductsCustomAdapter.OnItemClickListener{
    ...
    private static String JSON_URL = "https://my-json-server.typicode.com/cubby02/Fake_API/fish";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.category3);
        product = new ArrayList<>();
        errorPhoto = view.findViewById(R.id.error);
        errorText = view.findViewById(R.id.noInternet);
        swipeRefreshLayout = view.findViewById(R.id.categ3Refresh);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        cAdapter.setOnItemClickListener(fragmentCateg3.this);
                    }
