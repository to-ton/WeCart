...
public class ProductDetails extends AppCompatActivity {
    ...
    public void addProductToCart() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/add-to-cart.php?action=add_cart&username="+ buyer_name +"&seller="+ seller_name +"&product_name="+ prod_name +"&quantity="+ quantity_count +"";
