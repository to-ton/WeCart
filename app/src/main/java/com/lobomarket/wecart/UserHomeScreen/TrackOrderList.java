...
public class TrackOrderList extends AppCompatActivity implements OrderBreakDownAgentCustomAdapter.OnItemClickListener {
    ...
    private void showSummary() {
        try {
            ...
            String JSON_URL = "https://wecart.gq/wecart-api/show-orders.php?track="+ txtTracking +"";
    ...
    public void itemRecieved(){
        try {
            ...
            String url = "https://wecart.gq/wecart-api/deliver.php?buyer_delivered&buyer="+ txtUsername +"&tracking_id="+ txtTracking +"&key="+ txtQRkey +"";
            requestQueue = Volley.newRequestQueue(TrackOrderList.this);
