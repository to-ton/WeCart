...
public class EditAccountDetails extends AppCompatActivity {
    ...
    private void updateAccount() {
        try{
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/edituserinfo.php?buyer&username="+ txtusername +"&name="+ txtfullname +"&brgy="+ txtbrgy +"&sitio="+ txtsitio +"&street="+ txtstreet +"&contact_num="+ txtcontact +"&contact_email="+ txtemail +"";
