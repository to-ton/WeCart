...
public class AddAgent extends AppCompatActivity {
    ...
    private void addAgent(){
        ...
        String JSON_URL = "https://wecart.gq/wecart-api/register.php?agent&name="+ txtname +"&username="+ txtusername +"&password="+ password +"&brgy="+ brgy +"&sitio="+ txtsitio +"&street="+ txtstreet +"&contact_num="+ txtcontact +"&contact_email="+ txtemail +"";
