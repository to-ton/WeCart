...
public class fragmentsActiveAgents extends Fragment implements AgentCustomAdapter.OnItemClickListener {
    ...
    private void showUser() {
        try {
            agent.clear();
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/showusers.php?agentlist";
    ...
    private void deleteAgent() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/delete.php?agent="+ uName +"";
            RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
