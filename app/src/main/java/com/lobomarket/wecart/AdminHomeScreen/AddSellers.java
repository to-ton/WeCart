...
public class AddSellers extends AppCompatActivity {
    ...
    private void addSeller() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/register.php?seller&store_name="+ shop +"&store_type="+ storetype +"&description="+ null +"&name="+ null +"&username="+ username +"&password="+ password +"&brgy="+ null +"&sitio="+ null +"&street="+ null +"&contact_num="+ null +"&contact_email="+ txtmail +"";
