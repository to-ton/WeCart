...
public class fragmentSellers extends Fragment implements ActiveShopSellerCustomAdapter.OnItemClickListener {
    ...
    private void refreshList() {
        try {
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/showusers.php?seller";
    ...
    private void deleteSellerAccount() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/delete.php?seller="+ uName +"";
            RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
