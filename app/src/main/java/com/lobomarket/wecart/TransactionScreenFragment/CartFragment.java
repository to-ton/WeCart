...
public class CartFragment extends Fragment implements ViewCartCustomAdapter.MyCallback {
    ...
    private void showCart() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/show-orders.php?iscart="+ txtuser +"";
            cart.clear();
            requestQueue = Volley.newRequestQueue(getActivity());
    ...
    public void showFinalTotalPrice(){
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/show-orders.php?iscart="+ uname +"";
            requestQueue = Volley.newRequestQueue(getActivity());
    ...
    ItemTouchHelper.SimpleCallback callback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
        ...
        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
            try {
                ...
                String url = "https://jarvis.danlyt.ninja/wecart-api/v1/delete.php?buyer_user=" + txtBuyer + "&seller_user=" + txtSeller + "&product=" + txtProduct + "";
