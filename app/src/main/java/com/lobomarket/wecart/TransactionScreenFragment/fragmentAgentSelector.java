...
public class fragmentAgentSelector extends Fragment implements AgentSelectionCustomAdapter.OnItemClickListener {
    ...
    private void confirmAgent() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/add-to-cart.php?action=choose_agent&username="+ txtuser +"&agent="+ txtagent +"";
    ...
    private void refreshList() {
        try {
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/showusers.php?agents";
            StringRequest stringRequest = new StringRequest(
                    Request.Method.GET,
                    JSON_URL,
                    new Response.Listener<String>() {
    ...
    private void showUser() {
        try {
            agent.clear();
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/agent.php?active_list";
