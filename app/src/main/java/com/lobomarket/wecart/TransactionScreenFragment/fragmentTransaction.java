...
public class  fragmentTransaction extends Fragment {
    ...
    private void placeOrder() {
        try {
            ...
            String JSON_URL = "https:///wecart-api/add-to-cart.php?action=place_order&username="+ txtbuyer +"";
    ...
    public void setMOP(){
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/add-to-cart.php?action=order_summary&username="+ txtbuyer +"&mop="+ mTxtmop +"";
            RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
    ...
    private void showSummary() {
        try {
            ...
            String JSON_URL = "https://jarvis.danlyt.ninja/wecart-api/v1/add-to-cart.php?action=order_summary&username="+ txtbuyer +"&mop=null";
